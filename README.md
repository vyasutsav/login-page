...
<body>
  <h2>WELCOME TO THE NIBODH EDUCARE</h2>
  <h3>Click on the below button for the registration</h1>
  <button onclick="document.getElementById('id01').style.display='block'" style="width:auto;">Form Filling</button>
  ...
  <form class="modal-content" action="https://github.com/utssav">
    <div class="container">
      ...
      <input type="text"placeholder="Lastname"password="Lastname" required>
